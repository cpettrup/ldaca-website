...
const buttonColors = theme.value.buttonColors || {
  bg: '#79A38D',
  text: '#ffffff'
}
...
/* White divider lines used above Contact and bottom links */
.footer-divider {
...
<template>
  <div
    class="footer-border text-secondary"
    aria-hidden="true"
  ></div>

  <footer
    class="w-full mt-auto text-foreground"
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
        ...
        <div>
          ...
          >
            ...
            <h3
              v-else
              class="type-label-heading mb-1 text-[#393939]"
            >
              {{ navItem.text }}
            </h3>
        ...
        <div>
          ...
          <!-- Newsletter Section -->
          <div class="mb-8">
            <h3 class="type-label-heading mb-4 text-[#393939]">
          ...
          <!-- Contact Section -->
          <div class="mb-8 pt-8 border-t footer-divider">
            <h3 class="type-label-heading mb-4 text-[#393939]">
              Contact
            </h3>
          ...
          <div class="flex items-center gap-4">
            <a
              href="https://www.youtube.com/@LDaCA_Project"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.linkedin.com/company/ldaca/"
              target="_blank"
              rel="noopener noreferrer"
              class="text-[#383938] flex items-center gap-2 hover:text-gray-600 transition-colors"
            >
