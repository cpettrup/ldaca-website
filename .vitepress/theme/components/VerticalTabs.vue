...
<template>
  <section class="w-full pb-8" :style="props.backgroundColor ? { backgroundColor: props.backgroundColor } : {}">
    <div class="max-w-[1184px] mx-auto py-4 px-4 sm:px-6 md:px-8 lg:px-2">
      <!-- Header -->
      <div class="mb-12 text-left">
        <h2 class="type-page-title">{{ props.heading }}</h2>
        <p class="text-xl text-gray-600">{{ props.description }}</p>
      </div>
